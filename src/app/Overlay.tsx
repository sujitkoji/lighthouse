  ...
  return (
    <div className="fixed inset-0 z-10 pointer-events-none flex flex-col justify-between p-8 md:p-12 overflow-hidden">
      ...
      <div className="relative z-10 pointer-events-none">
        ...
        >
          <h1 className="text-[8vw] leading-[0.8] font-black text-transparent stroke-text tracking-tighter mix-blend-overlay opacity-40 uppercase">
            OCEANIC
          </h1>
          <h1 className="text-[9vw] leading-[0.8] font-black text-white tracking-tighter -mt-[3vw] drop-shadow-2xl uppercase">
            GUIDE
          </h1>
